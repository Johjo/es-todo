...
class BaseTestTodolist:
    def test_should_list_open_tasks(self, sut: TodolistPort, fake: TodolistFaker, current_user: str):
    ...
    def test_should_list_only_task_having_one_included_context(self, sut: TodolistPort, fake: TodolistFaker,
        ...
        assert sut.all_open_tasks(task_filter) == [Task(key=task.to_key()) for task in
                                                   expected_tasks]
    ...
    def test_should_not_list_task_having_any_excluded_context(self, sut: TodolistPort, fake: TodolistFaker, current_user: str):
        expected_tasks = [fake.a_task().having(name="buy the milk #supermarket"), ]
    ...
    def test_should_include_only_task_matching_full_context(self, sut: TodolistPort, fake: TodolistFaker, current_user: str):
    ...
    def test_should_exclude_only_task_matching_full_context(self, sut: TodolistPort, fake: TodolistFaker, current_user: str):
    ...
    def test_should_exclude_task_having_execution_task_in_future(self, sut: TodolistPort, fake: TodolistFaker, current_user: str):
