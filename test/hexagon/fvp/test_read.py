...
from hexagon.fvp.domain_model import NothingToDo, DoTheTask, Task, ChooseTheTask
...
@pytest.fixture
def sut(set_of_open_tasks: SimpleTaskReader):
    return WhichTaskQuery(set_of_open_tasks)
